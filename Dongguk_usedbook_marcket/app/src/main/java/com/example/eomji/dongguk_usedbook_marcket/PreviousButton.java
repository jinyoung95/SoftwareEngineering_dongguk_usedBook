...
public class PreviousButton extends Button {
    ...
    int bitmapAlign = BITMAP_ALIGN_CENTER;  //Alignment
    int bitmapPadding = 10;                 //Padding for Left or Right
    ...
    public PreviousButton(Context context, AttributeSet atts) {
        super(context, atts);
        this.context = context;
        init();
    }
